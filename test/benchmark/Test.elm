...
mySuite =
  Benchmark.Suite "Decoding suite"
    ...
    , Benchmark.bench2  "Core: generate a massive integer" Ran.generate (Ran.int 0 0xFFFFFFFF) coreSeed
    , Benchmark.bench2  "PCG:  generate a massive integer" PCG.generate (PCG.int 0 0xFFFFFFFF) pcgSeed
